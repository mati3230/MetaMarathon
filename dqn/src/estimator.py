...
class Estimator():
    ...
    def _build_model(self):
        ...
        conv1 = tf.contrib.layers.conv2d(
            X, num_outputs=32, kernel_size=8, stride=4, activation_fn=tf.nn.relu)
        conv2 = tf.contrib.layers.conv2d(
            conv1, num_outputs=64, kernel_size=4, stride=2, activation_fn=tf.nn.relu)
        conv3 = tf.contrib.layers.conv2d(
            conv2, num_outputs=64, kernel_size=3, stride=1, activation_fn=tf.nn.relu)
